...
```bash
 ...
 ./requitement.sh
```
   "اگر به مشکلاتی در اجرای requirement.sh در PythonAnywhere همچنین برخورد کردید، ساده‌است که کنسول را ببندید، ۱۵ دقیقه صبر کنید، سپس کنسول را دوباره باز کنید و دوباره تلاش کنید. اگر مشکل ادامه دارد، سعی کنید اسکریپت را با استفاده از nano requirement.sh ویرایش کنید، بدون اعمال هرگونه تغییر، بعد از آن اسکریپت را دوباره اجرا کنید."
